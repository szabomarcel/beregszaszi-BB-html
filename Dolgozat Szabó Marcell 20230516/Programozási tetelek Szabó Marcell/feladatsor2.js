...
console.log(kor(t, t2))

// 12. Feladat
let t1 = [1, 5, -2, 6, 9, 10, -100, 13, 14, 18, 20, 100];
let t3 = [-1,-6, 2, -9, 11, 100, -12, -13, -14]
function paros(){
    let negativ = []
...
// 13. Feladat
let t4 = [1, 5, -2, 6, 9, 10, -100, 13, 14, 18, 20, 100];
let t5 = [-1,-6, 2, -9, 11, 100, -12, -13, -14]
function paros(){
    let negativ = []
        for(i = 1; i < t1.length; i++){
            if(t[i] == 0){
...
function tomb(){
    let nevek = [];
    if(nevek != nevek){
        console.log("Részszövegez tartalmaz!") 
    }else{
...
function primtenyezos(){
    ...
    if(szam % oszto){
        ...
        console.log("Ez eltért a megadott számtól")
    }    
}
Console.log(kiir);
